...
class SolderStation extends StatefulWidget {
  const SolderStation({Key? key, this.animationController}) : super(key: key);
...
class _SolderStationState extends State<SolderStation>
  ...
  Future<void> startMQTT() async {
    ...
    const topic1 = 'UCL/OPS/107/EM/gosund/sandy-solder-station/SENSOR';
