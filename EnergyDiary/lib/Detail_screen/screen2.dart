...
void add(BuildContext context) async {
  ...
  try {
    print('Add data: $Today');
    // update the 'Screen2' field in the document with the current time
    await FirebaseFirestore.instance
        .collection('Date')
        .doc('${Time.substring(0, 10)}')
        .update({
...
class _screen2State extends State<screen2> with ScreenLoader {
  @override
  void initState() {
    startMQTT();
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                        ...
                        child: TitleView(
                          titleTxt: 'Sammy, Samsung Screen 2',
                        )),
                    Padding(
                    ...
                    Padding(
                        ...
                        child: SingleDeviceGraph(device:'Screen2')),
                    Padding(
                        padding: EdgeInsets.only(
                            top: 1420,
                            left: 0.23 * MediaQuery.of(context).size.width),
                          ...
                          Padding(
                            ...
                            child: CustomPaint(
                              painter: CurvePainter(
                                  ...
                                  //The maxmium active power is estimated as 360 W. Tne responsive circle is 360 degree and is then divided into 360 portions (1 degrees each):
