...
void add(BuildContext context) async {
  ...
  try {
    print('Add data: $Today');
    // update the 'Printer4' field in the document with the current time
    await FirebaseFirestore.instance
        .collection('Date')
        .doc('${Time.substring(0, 10)}')
        .update({
...
class _printer4State extends State<printer4> with ScreenLoader {
  @override
  void initState() {
    startMQTT();
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                        ...
                        child: TitleView(
                          titleTxt: 'Penelope, Single-Filament 3D Printer 4',
                        )),
                    Padding(
                    ...
                    Padding(
                        ...
                        child: SingleDeviceGraph(device:'Printer4')),
                    Padding(
                        padding: EdgeInsets.only(
                            top: 1420,
                            left: 0.23 * MediaQuery.of(context).size.width),
