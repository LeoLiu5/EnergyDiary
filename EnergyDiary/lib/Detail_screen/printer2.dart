...
void add(BuildContext context) async {
  ...
  try {
    print('Add data: $Today');
    // update the 'Printer2' field in the document with the current time
    await FirebaseFirestore.instance
        .collection('Date')
        .doc('${Time.substring(0, 10)}')
        .update({
...
class _printer2State extends State<printer2> with ScreenLoader {
  ...
  Future<void> startMQTT() async {
    ...
    const topic1 = 'UCL/OPS/107/EM/gosund/pertuina-the-prusa-2/SENSOR';
                ...
                child: Stack(
                  children: <Widget>[
                    Padding(
                        ...
                        child: TitleView(
                          titleTxt: 'Pertuina, Single-Filament 3D Printer 2',
                        )),
                    Padding(
                    ...
                    Padding(
                        ...
                        child: SingleDeviceGraph(device:'Printer2')),
                    Padding(
                        padding: EdgeInsets.only(
                            top: 1420,
                            left: 0.23 * MediaQuery.of(context).size.width),
                ...
                children: <Widget>[
                  ...
                  SizedBox(
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        client.disconnect(); print("client disconnected");
